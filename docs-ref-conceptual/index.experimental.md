...
layout: HubPage
hide_bc: true
title: Node.js Dev Center | Microsoft-Dokumentation
...
ms.locfileid: "34761311"
---
<div id="main" class="v2">
    <div class="container">
        <h1 style="text-align: center">Node.js Dev Center</h1> 
        <p style="text-align: center">Erstellen, Bereitstellen und Skalieren Ihrer Node.js-Anwendung in der Azure-Cloud</p>
...
install azure-cli az login az group create --name MyResourceGroup --location &quot;West US&quot; </code></pre>
